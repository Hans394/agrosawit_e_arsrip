...
<div class="container mt-5 pt-5 mb-5">
    ...
    <!-- Card Form -->
    <div class="p-4 rounded-4" style="background-color: #D8E9A8; max-width:800px; margin:auto;">
        ...
        <form action="{{ route('arsip_user.store') }}" method="POST" enctype="multipart/form-data" class="mt-4">
            @csrf
            ...
            <div class="mt-3">
                ...
                <div class="border border-2 border-secondary-subtle rounded-4 p-4 text-center bg-light">
                    ...
                    <label for="fileInput" class="w-100" style="cursor:pointer;">
                        ...
                        <p class="mb-1 text-primary fw-semibold mt-2" id="labelFile">Klik Untuk Upload</p>
